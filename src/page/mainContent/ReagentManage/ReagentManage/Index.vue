<template>
	<div class="app-container ReagentManage">
		<!-- 头部input搜索 -->
		<div class="Search_Top_Input">
			...
			<div class="addNew" style="width: 150px !important">
				<span @click="add()"><i class="el-icon-circle-plus-outline"></i> 新增试剂</span>
			</div>
		</div>
		<!-- table -->
		<sys-table 
		...
		<div class="zll-dialog">
			<popout :title="'试剂管理 · ' + title " :visible.sync="addDialog" v-if="addDialog" class="ReagentManage">
